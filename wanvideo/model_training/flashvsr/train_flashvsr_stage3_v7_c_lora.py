                    ...
                    json.dump(
                        {
                            ...
                            "validation_mode": "stage3_v7_d_streaming_kvcache_one_step",
...
def launch_stage3c_dual_optimizer_task(
    ...
    """Dedicated v7-C runner skeleton with a second optimizer state path."""
...
def main(argv=None):
    ...
    if args.validation_num_samples > 0 and accelerator.is_main_process:
        print(
            "Preparing fixed Stage3 v7-C validation samples... "
