...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage1_release_16gpu_v5_3_phase2_unfreeze_template.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage1_release_16gpu_v5_3_phase2_unfreeze}"
...
if [[ -z "${STAGE1_CKPT}" ]]; then
  echo "STAGE1_CKPT is required. Set it to the chosen freezeproj checkpoint path." >&2
  exit 1
fi
...
SELF_SH="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/lora/history/FlashVSR-Stage1-Release-16GPU-v5-3-Phase2-Unfreeze-Template.sh"
