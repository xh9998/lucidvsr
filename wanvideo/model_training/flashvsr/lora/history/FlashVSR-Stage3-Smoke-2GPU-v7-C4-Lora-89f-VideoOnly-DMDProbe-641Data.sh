...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage3_release_smoke_2gpu_v7_c4_lora_89f_videoonly_dmdprobe_641data.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_release_smoke_2gpu_v7_c4_lora_89f_videoonly_dmdprobe_641data}"
...
echo "stage3_v7_c4=logging_only_dmd_probe data=641_v6_4_1"
