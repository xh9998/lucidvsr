...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage3_release_smoke_2gpu_v7_d_lora_89f_videoonly_authorweights_val3_notile.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_release_smoke_2gpu_v7_d_lora_89f_videoonly_authorweights_val3_notile}"
...
echo "stage3_v7_d_smoke=author_weights fake_fm=1 dmd=1 dmd_spike=skip@5 val3_notile"
