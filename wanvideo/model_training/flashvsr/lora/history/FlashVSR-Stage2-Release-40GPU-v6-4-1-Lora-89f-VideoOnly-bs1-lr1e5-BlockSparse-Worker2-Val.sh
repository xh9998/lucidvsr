...
CONFIG_PATH="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage2_release_40gpu_v6_4_1_lora_89f_videoonly_bs1_lr1e5_blocksparse_worker2_val.yaml"
OUTPUT_TAG="train_stage2_release_40gpu_v6_4_1_lora_89f_videoonly_bs1_lr1e5_blocksparse_worker2_val"
...
TRAIN_PY="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/train_flashvsr_stage2_v6_4_lora.py"
...
echo "stage2_v641_lr=1e-5 target=first_85_frames validation=v6.1_streaming_kvcache topk=chunk_grouped_no_spatial_local_mask"
