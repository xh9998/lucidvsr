...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage3_release_smoke_2gpu_v7_d3_1_teacher_aligned_clean.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_release_smoke_2gpu_v7_d3_1_teacher_aligned_clean}"
...
echo "stage3_v7_d3_1_teacher_aligned force_recon_start=${FLASHVSR_STAGE3_FORCE_RECON_START}"
echo "v7-D3.1 expects Stage1 teacher projector nonstreaming_aligned and DMD lq alignment trim_front_to_match"
