...
CONFIG_PATH="${CONFIG_PATH:-$REPO_DIR/wanvideo/model_training/flashvsr/configs/history/stage1_release_smoke_2gpu_v2_17f_takano_resume_step1000_seed20260414.yaml}"
...
RUN_NAME="${OUTPUT_TAG:-train_stage1_release_smoke_2gpu_v2_17f_takano_resume_step1000_seed20260414}_${RUN_TS}"
