...
export FLASHVSR_STAGE3_FORCE_RECON_START=0
...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage3_release_smoke_2gpu_v7_d2_firstframe_weightcheck.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_release_smoke_2gpu_v7_d2_firstframe_weightcheck}"
...
echo "stage3_v7_d2_firstframe_weightcheck force_recon_start=${FLASHVSR_STAGE3_FORCE_RECON_START}"
echo "expect latent_window=[0,2) first_frame_pixel_weight=4.0 first_frame_lpips_weight=4.0"
