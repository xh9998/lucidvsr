...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage3_release_smoke_2gpu_v7_d4_dfake5.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_release_smoke_2gpu_v7_d4_dfake5}"
...
echo "stage3_v7_d4_dfake5 force_recon_start=${FLASHVSR_STAGE3_FORCE_RECON_START}"
echo "v7-D4 expects DMD2-style dfake_gen_update_ratio=5: fake updates every runner step, student updates every 5 runner steps"
