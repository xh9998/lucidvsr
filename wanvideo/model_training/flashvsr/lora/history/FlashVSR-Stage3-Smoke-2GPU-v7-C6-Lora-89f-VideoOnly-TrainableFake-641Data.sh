...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage3_release_smoke_2gpu_v7_c6_lora_89f_videoonly_trainablefake_641data.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_release_smoke_2gpu_v7_c6_lora_89f_videoonly_trainablefake_641data}"
...
echo "stage3_v7_c6=trainable_gfake fake_fm data=641_v6_4_1"
