...
CONFIG_PATH="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage1_release_48gpu_v5_3_5_lora_89f_fullsources_bs1_lr1e5_aliyundegra_randomproj_img5_nonstreamproj_segmentalign.yaml"
OUTPUT_TAG="train_stage1_release_48gpu_v5_3_5_lora_89f_fullsources_bs1_lr1e5_aliyundegra_randomproj_img5_nonstreamproj_segmentalign"
...
SELF_SH="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/lora/history/FlashVSR-Stage1-Release-48GPU-v5-3-5-Lora-89f-FullSources-bs1-lr1e5-AliyunDegra-RandomProj-Img5-NonStreamProj-SegmentAlign.sh"
