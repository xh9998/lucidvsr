...
CONFIG_PATH="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage2_release_48gpu_v6_lora_89f_videoonly_bs1_lr1e5_blocksparse_worker2.yaml"
OUTPUT_TAG="train_stage2_release_48gpu_v6_lora_89f_videoonly_bs1_lr1e5_blocksparse_worker2"
...
TRAIN_PY="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/train_flashvsr_stage2_v6_lora.py"
...
cp "/mnt/task_runtime/lucidvsr/diffsynth/models/wan_video_dit_stage2_v6.py" "${RUN_DIR}/snapshot/" || true
