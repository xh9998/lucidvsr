...
: "${GRAD_CASE:?GRAD_CASE must be one of Grad-A,Grad-B,Grad-C,Grad-D,Grad-E}"
...
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_gradcheck_16gpu_v7_d4_1_${GRAD_CASE}}"
...
TRAIN_PY="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/train_flashvsr_stage3_v7_d4_1_gradcheck_lora.py"
...
case "${GRAD_CASE}" in
  ...
  Grad-C)
    ...
    ;;
  Grad-D)
    CASE_ARGS=(--stage3_flow_weight 0 --stage3_mse_weight 0 --stage3_lpips_weight 0 --stage3_dmd_weight 0 --stage3_fake_fm_weight 1 --max_train_steps 2)
    ;;
  Grad-E)
...
echo "stage3_gradcheck case=${GRAD_CASE}"
