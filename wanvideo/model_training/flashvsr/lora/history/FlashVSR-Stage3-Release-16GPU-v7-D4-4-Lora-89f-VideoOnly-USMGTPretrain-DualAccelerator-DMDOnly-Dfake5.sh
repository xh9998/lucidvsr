...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage3_release_16gpu_v7_d4_4_lora_89f_videoonly_usmgtpretrain_dualaccelerator_dmdonly_dfake5.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_release_16gpu_v7_d4_4_lora_89f_videoonly_usmgtpretrain_dualaccelerator_dmdonly_dfake5}"
...
echo "stage3_v7_d4_4_dmdonly=1 student_losses=stage3_dmd_only fake_fm=1 dfake_gen_update_ratio=5"
