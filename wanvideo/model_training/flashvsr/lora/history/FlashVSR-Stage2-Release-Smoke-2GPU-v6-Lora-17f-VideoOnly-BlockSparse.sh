...
CONFIG_PATH="${CONFIG_PATH:-${REPO_ROOT}/wanvideo/model_training/flashvsr/configs/history/stage2_release_smoke_2gpu_v6_lora_17f_videoonly_blocksparse.yaml}"
...
OUTPUT_TAG="${OUTPUT_TAG:-train_stage2_release_smoke_2gpu_v6_lora_17f_videoonly_blocksparse}"
