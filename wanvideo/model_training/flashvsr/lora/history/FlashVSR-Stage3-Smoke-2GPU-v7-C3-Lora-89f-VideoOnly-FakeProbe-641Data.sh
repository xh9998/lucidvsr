...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage3_release_smoke_2gpu_v7_c3_lora_89f_videoonly_fakeprobe_641data.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_release_smoke_2gpu_v7_c3_lora_89f_videoonly_fakeprobe_641data}"
...
: "${RESUME_STAGE2_CHECKPOINT:?RESUME_STAGE2_CHECKPOINT must point to Stage2 v6 checkpoint, e.g. step-6000.safetensors}"
STAGE3_FAKE_PROBE_CHECKPOINT="${STAGE3_FAKE_PROBE_CHECKPOINT:-${RESUME_STAGE2_CHECKPOINT}}"
...
echo "stage3_fake_probe_checkpoint=${STAGE3_FAKE_PROBE_CHECKPOINT}"
echo "extra_args=${EXTRA_ARGS:-}"
echo "stage3_v7_c3=dual_optimizer_skeleton_plus_frozen_gfake_probe data=641_v6_4_1"
...
CMD=(/mnt/conda_envs/flashvsr/bin/accelerate launch
  ...
  --stage3_fake_probe_checkpoint "${STAGE3_FAKE_PROBE_CHECKPOINT}"
