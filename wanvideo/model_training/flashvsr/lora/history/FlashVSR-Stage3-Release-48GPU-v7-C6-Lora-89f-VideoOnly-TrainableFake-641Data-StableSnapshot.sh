...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage3_release_48gpu_v7_c6_lora_89f_videoonly_trainablefake_641data.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_release_48gpu_v7_c6_lora_89f_videoonly_trainablefake_641data}"
...
TRAIN_PY="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/train_flashvsr_stage3_v7_c6_stable.py"
...
echo "stage3_v7_c6=trainable_gfake fake_fm dmd_student_loss validation=one_step_aux_offload"
