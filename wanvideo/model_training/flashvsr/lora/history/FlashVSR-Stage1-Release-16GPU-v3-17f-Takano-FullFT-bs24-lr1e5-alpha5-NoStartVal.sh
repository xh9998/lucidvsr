...
CONFIG_PATH="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage1_release_16gpu_v3_17f_takano_fullft_bs24_lr1e5_alpha5_nostartval.yaml"
OUTPUT_TAG="train_stage1_release_16gpu_v3_17f_takano_fullft_bs24_lr1e5_alpha5_nostartval"
HISTORY_DIR="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/lora/history"
TEMPLATE_YAML="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/lora/history/accelerate_zero2_flashvsr_2node16gpu_noactckpt.template.yaml"
...
TRAIN_PY="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/train_flashvsr_stage1_v3.py"
SELF_SH="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/lora/history/FlashVSR-Stage1-Release-16GPU-v3-17f-Takano-FullFT-bs24-lr1e5-alpha5-NoStartVal.sh"
ACCEL_YAML="${RUN_DIR}/accelerate_2node16gpu_noactckpt.yaml"
...
cp "/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/lora/history/deepspeed_zero2_flashvsr_noactckpt.json" "${RUN_DIR}/snapshot/" || true
