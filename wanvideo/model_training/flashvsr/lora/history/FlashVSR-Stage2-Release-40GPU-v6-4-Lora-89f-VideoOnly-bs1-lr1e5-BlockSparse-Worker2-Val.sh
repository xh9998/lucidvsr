...
CONFIG_PATH="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage2_release_48gpu_v6_4_lora_89f_videoonly_bs1_lr1e5_blocksparse_worker2_val.yaml"
OUTPUT_TAG="train_stage2_release_40gpu_v6_4_lora_89f_videoonly_bs1_lr1e5_blocksparse_worker2_val"
...
echo "stage2_v64_lr=1e-5 target=first_85_frames validation=v6.1_streaming_kvcache"
