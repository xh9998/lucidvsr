...
CONFIG_PATH="${CONFIG_PATH:-/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage3_release_smoke_2gpu_v7_c2_lora_89f_videoonly_realprobe_641data.yaml}"
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_release_smoke_2gpu_v7_c2_lora_89f_videoonly_realprobe_641data}"
...
echo "stage3_v7_c2=dual_optimizer_skeleton_plus_frozen_greal_probe data=641_v6_4_1"
