...
export FLASHVSR_STAGE3_PARAM_GRAD_DEBUG="${FLASHVSR_STAGE3_PARAM_GRAD_DEBUG:-0}"
...
: "${GRAD_CASE:?GRAD_CASE must be one of Ownership, Pixel, DMD, Fake, All, FakeLoraOnly, FakeLqProjOnly, GradScale, ParamGrad, ParamFlow, ParamMSE, ParamLPIPS, ParamDMD}"
...
OUTPUT_TAG="${OUTPUT_TAG:-train_stage3_paramgrad_16gpu_v7_d4_4_${GRAD_CASE}}"
...
case "${GRAD_CASE}" in
  ...
  ParamGrad)
    export FLASHVSR_STAGE3_GRAD_SCALE_DEBUG=1
    export FLASHVSR_STAGE3_PARAM_GRAD_DEBUG=1
    CASE_ARGS=(--stage3_flow_weight 1 --stage3_mse_weight 1 --stage3_lpips_weight 2 --stage3_dmd_weight 1 --stage3_fake_fm_weight 1 --max_train_steps 2)
    ;;
  ParamFlow)
...
echo "stage3_d44_paramgrad case=${GRAD_CASE}"
