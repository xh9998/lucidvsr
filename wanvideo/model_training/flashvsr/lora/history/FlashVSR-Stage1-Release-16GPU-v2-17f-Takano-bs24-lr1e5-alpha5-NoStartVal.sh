...
CONFIG_PATH="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/configs/history/stage1_release_16gpu_v2_17f_takano_bs24_lr1e5_alpha5_nostartval.yaml"
OUTPUT_TAG="train_stage1_release_16gpu_v2_17f_takano_bs24_lr1e5_alpha5_nostartval"
HISTORY_DIR="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/lora/history"
TEMPLATE_YAML="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/lora/history/accelerate_zero2_flashvsr_2node16gpu.template.yaml"
...
SELF_SH="/mnt/task_runtime/lucidvsr/wanvideo/model_training/flashvsr/lora/history/FlashVSR-Stage1-Release-16GPU-v2-17f-Takano-bs24-lr1e5-alpha5-NoStartVal.sh"
