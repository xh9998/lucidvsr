...
CONFIG_PATH="${CONFIG_PATH:-${REPO_ROOT}/wanvideo/model_training/flashvsr/configs/history/stage2_release_smoke_2gpu_v6_4_lora_89f_videoonly_bs1_lr1e5_blocksparse_worker2.yaml}"
...
OUTPUT_TAG="${OUTPUT_TAG:-train_stage2_release_smoke_2gpu_v6_4_lora_89f_videoonly_bs1_lr1e5_blocksparse_worker2}"
TRAIN_PY="${REPO_ROOT}/wanvideo/model_training/flashvsr/train_flashvsr_stage2_v6_4_lora.py"
...
cp "${REPO_ROOT}/diffsynth/models/wan_video_dit_stage2_v6_1.py" "${RUN_DIR}/snapshot/" || true
