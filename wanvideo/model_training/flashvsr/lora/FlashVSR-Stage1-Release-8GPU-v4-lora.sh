...
RUN_NAME="train_stage1_release_8gpu_v4_lora_${RUN_TS}"
RUN_DIR="${EXP_ROOT}/${RUN_NAME}"
mkdir -p "${RUN_DIR}"

TRAIN_PY="wanvideo/model_training/flashvsr/train_flashvsr_stage1_v4_lora.py"
CONFIG_YAML="wanvideo/model_training/flashvsr/configs/stage1_release_8gpu_v4_lora.yaml"
ACCEL_YAML="wanvideo/model_training/flashvsr/lora/accelerate_zero2_flashvsr_8gpu.yaml"
SELF_SH="wanvideo/model_training/flashvsr/lora/FlashVSR-Stage1-Release-8GPU-v4-lora.sh"
