...
from diffsynth.models.wan_video_dit_stage2_v6_clean import enable_stage2_causal_attention, set_stage2_grid
...
from wanvideo.model_training.flashvsr import train_flashvsr_stage1_v5_3_clean_lora as v5
...
def _stage2_parser():
    ...
    parser.add_argument(
        ...
        choices=("block_sparse_chunk_causal", "dense_full"),
