...
def _append_flashvsr_debug(filename: str, message: str) -> None:
    # Clean release entrypoint: keep the hook for compatibility, but do not
    # write side-channel debug logs from the training hot path.
    return
...
def main():
    ...
    if args.dataset_mode == "streaming":
        ...
        dataset = FlashVSRTarStreamingDatasetV53(
            yubari_video_tar_url=args.yubari_video_tar_url,
