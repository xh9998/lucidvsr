...
from wanvideo.model_training.flashvsr.train_flashvsr_stage2_v6_lora import FlashVSRStage2Pipeline
...
def add_common_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--stage2_attention_mode", type=str, default="block_sparse_chunk_causal", choices=("block_sparse_chunk_causal", "dense_full"))
...
def main():
    parser = argparse.ArgumentParser(description="Stage2 v6 block-sparse causal inference.")
