...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Batch Stage3 v7-D one-step inference using the same streaming/KV-cache "
            "path as v7-D validation. Loads Wan/VAE/projector once per checkpoint."
        )
    )
    ...
    print("stage3_v7_d_batch_inference=streaming_kvcache_one_step")
