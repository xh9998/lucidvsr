...
from wanvideo.model_inference.flashvsr.infer_flashvsr_stage2_v6 import (
    add_common_args,
    build_stage2_pipe,
    run_single_video,
)
...
def main():
    parser = argparse.ArgumentParser(description="Batch inference for Stage2 v6 checkpoints.")
    ...
    for index, input_video in enumerate(input_videos, start=1):
        ...
        video_args.output_video = os.path.join(args.output_dir, f"{sample}{args.output_suffix}.mp4")
