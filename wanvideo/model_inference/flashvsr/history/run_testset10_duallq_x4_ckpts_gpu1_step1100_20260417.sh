...
run_dir="${OUTPUT_ROOT}/train_stage1_release_16gpu_v2_89f_takano_bs4_lr1e5_alpha5_resume_step1000_seed20260415_20260415_012200_step-1100_testset10_89f"
mkdir -p "${run_dir}"
: > "${run_dir}/run.log"

for input_video in "${TESTSET_ROOT}/testset10_89f/lq_x4"/*.mp4; do
  sample_name="$(basename "${input_video}" .mp4)"
  output_video="${run_dir}/${sample_name}_sr.mp4"

  {
    echo "TAG=train_stage1_release_16gpu_v2_89f_takano_bs4_lr1e5_alpha5_resume_step1000_seed20260415_20260415_012200"
    echo "STEP=step-1100"
    echo "KIND=lora"
    echo "CHECKPOINT=${LOCAL_CKPT_DIR}/m2_train_stage1_release_16gpu_v2_89f_takano_bs4_lr1e5_alpha5_resume_step1000_seed20260415_20260415_012200_step-1100.safetensors"
    echo "TESTSET_VARIANT=testset10_89f"
    ...
    /mnt/conda_envs/flashvsr/bin/python \
      ...
      --checkpoint_path "${LOCAL_CKPT_DIR}/m2_train_stage1_release_16gpu_v2_89f_takano_bs4_lr1e5_alpha5_resume_step1000_seed20260415_20260415_012200_step-1100.safetensors" \
