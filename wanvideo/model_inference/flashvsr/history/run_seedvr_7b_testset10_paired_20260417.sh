...
MODEL_DIR="${MODEL_DIR:-/mnt/models/SeedVR-7B}"
TESTSET_ROOT="${TESTSET_ROOT:-/mnt/task_wrapper/user_output/artifacts/input/testset10_paired}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/mnt/task_wrapper/user_output/artifacts/inference/seedvr_7b_testset10_paired_20260417}"
...
ln -sfn "${MODEL_DIR}/seedvr_ema_7b.pth" "${SEEDVR_ROOT}/ckpts/seedvr_ema_7b.pth"
...
run_variant() {
  ...
  "${SEEDVR_PYTHON}" projects/inference_seedvr_7b.py \
