...
run_dir="${OUTPUT_ROOT}/train_stage1_release_16gpu_v2_17f_takano_bs24_lr1e5_alpha5_resume_step1000_seed20260416_20260415_024800_step-1000_testset10_17f"
mkdir -p "${run_dir}"
: > "${run_dir}/run.log"
...
for input_video in "${TESTSET_ROOT}/testset10_17f/lq_x4"/*.mp4; do
  ...
  {
    echo "TAG=train_stage1_release_16gpu_v2_17f_takano_bs24_lr1e5_alpha5_resume_step1000_seed20260416_20260415_024800"
    echo "STEP=step-1000"
    echo "KIND=lora"
