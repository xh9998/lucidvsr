...
CKPT_DIR="${CKPT_DIR:-/mnt/task_wrapper/user_output/artifacts/ckpts/stage2_v6_89f_step500_20260508}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-/mnt/task_wrapper/user_output/artifacts/inference/stage2_v6_worker2_scan89_v62_fullmask_20260508_8way}"
S3_OUTPUT_DIR="${S3_OUTPUT_DIR:-s3://lxh/tmp/stage2_v6_worker2_scan89_v62_fullmask_20260508_8way}"
...
echo "[info] mode=v6.2 full-sequence DiT with training mask, no KV cache"
...
ckpt_list="${OUTPUT_ROOT}/logs/stage2_v6_step500_s3_ckpt_list.txt"
