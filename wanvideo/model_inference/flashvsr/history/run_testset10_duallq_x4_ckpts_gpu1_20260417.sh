...
run_dir="${OUTPUT_ROOT}/train_stage1_release_16gpu_v2_89f_takano_bs4_lr1e5_alpha5_resume_step1000_seed20260415_20260415_012200_step-1200_testset10_89f"
mkdir -p "${run_dir}"
: > "${run_dir}/run.log"
...
for input_video in "${TESTSET_ROOT}/testset10_89f/lq_x4"/*.mp4; do
...

  {
    ...
    echo "STEP=step-1200"
    echo "KIND=lora"
    echo "CHECKPOINT=${LOCAL_CKPT_DIR}/m2_train_stage1_release_16gpu_v2_89f_takano_bs4_lr1e5_alpha5_resume_step1000_seed20260415_20260415_012200_step-1200.safetensors"
    ...
    /mnt/conda_envs/flashvsr/bin/python \
      ...
      --checkpoint_path "${LOCAL_CKPT_DIR}/m2_train_stage1_release_16gpu_v2_89f_takano_bs4_lr1e5_alpha5_resume_step1000_seed20260415_20260415_012200_step-1200.safetensors" \
