...
SYNTHETIC_ROOT="${SYNTHETIC_ROOT:-/mnt/task_wrapper/user_output/artifacts/data/inference/testset50_89f_random25takano25yubari_light_x4_lq_20260518}"
SYNTHETIC_S3="${SYNTHETIC_S3:-s3://lxh/data/test/testset50_89f_random25takano25yubari_light_x4_lq_20260518}"
...
record_time() {
  ...
  {
    echo "method=${method}"
    echo "dataset=synthetic_89f_random50"
    echo "status=${status}"
...
{
  echo "benchmark=ppt_benchmark_50random_synthetic_20260518"
