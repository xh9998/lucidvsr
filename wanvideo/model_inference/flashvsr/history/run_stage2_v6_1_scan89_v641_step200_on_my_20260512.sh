...
CKPT_DIR="${CKPT_DIR:-/mnt/task_wrapper/user_output/artifacts/ckpts/stage2_v6_4_1_89f_step200_20260512}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-/mnt/task_wrapper/user_output/artifacts/inference/stage2_v6_4_1_scan89_v61_step200_20260512}"
S3_OUTPUT_DIR="${S3_OUTPUT_DIR:-s3://lxh/tmp/stage2_v6_4_1_scan89_v61_step200_20260512}"
...
STEP_MOD="${STEP_MOD:-200}"
MIN_STEP="${MIN_STEP:-200}"
...
ckpt_list="${OUTPUT_ROOT}/logs/stage2_v6_4_1_step200_s3_ckpt_list.txt"
...
printf '%s\n' "${CKPTS[@]}" > "${OUTPUT_ROOT}/logs/step200_to_test.txt"
echo "[info] new_ckpts_to_test=${#CKPTS[@]}"
cat "${OUTPUT_ROOT}/logs/step200_to_test.txt"
