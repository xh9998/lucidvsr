...
OUTPUT_ROOT="${OUTPUT_ROOT:-/mnt/task_wrapper/user_output/artifacts/inference/stage2_v6_early_ckpts_v62_20260510}"
S3_OUTPUT_DIR="${S3_OUTPUT_DIR:-s3://lxh/tmp/stage2_v6_early_ckpts_v62_20260510}"
...
echo "[info] mode=v6.2 full-sequence masked DiT, no KV cache"
