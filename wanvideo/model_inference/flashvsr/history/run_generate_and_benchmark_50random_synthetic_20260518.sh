...
DATA_ROOT="${DATA_ROOT:-/mnt/task_wrapper/user_output/artifacts/data/inference/testset50_89f_random25takano25yubari_light_x4_lq_20260518}"
DATA_S3="${DATA_S3:-s3://lxh/data/test/testset50_89f_random25takano25yubari_light_x4_lq_20260518}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/mnt/task_wrapper/user_output/artifacts/inference/ppt_benchmark_50random_synthetic_20260518}"
OUTPUT_S3="${OUTPUT_S3:-s3://lxh/data/test/ppt_benchmark_50random_synthetic_20260518}"
...
bash -n wanvideo/model_inference/flashvsr/history/run_ppt_benchmark_50random_synthetic_20260518.sh
...
if [[ ! -s "${DATA_ROOT}/summary.json" ]]; then
  ...
  "${PYTHON_BIN}" -u wanvideo/data/flashvsr/tests/export_inference_testset50_random_takano_yubari_light_x4_lq.py \
    ...
    --num_per_source 25 \
    --seed "${SEED}" \
    2>&1 | tee "${LOG_DIR}/export_testset50_random_20260518.log"
else
...
bash wanvideo/model_inference/flashvsr/history/run_ppt_benchmark_50random_synthetic_20260518.sh \
  2>&1 | tee "${LOG_DIR}/ppt_benchmark_50random_synthetic_20260518.log"
