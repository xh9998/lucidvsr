...
OUTPUT_ROOT="${OUTPUT_ROOT_FLASHVSR:-/mnt/task_wrapper/user_output/artifacts/inference/flashvsr_full_testset10_paired_4x_20260417}" \
...
OUTPUT_ROOT="${OUTPUT_ROOT_SEEDVR3B:-/mnt/task_wrapper/user_output/artifacts/inference/seedvr_3b_testset10_paired_4x_20260417}" \
...
OUTPUT_ROOT="${OUTPUT_ROOT_SEEDVR7B:-/mnt/task_wrapper/user_output/artifacts/inference/seedvr_7b_testset10_paired_4x_20260417}" \
