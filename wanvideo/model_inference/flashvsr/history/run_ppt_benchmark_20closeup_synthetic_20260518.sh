...
SYNTHETIC_ROOT="${SYNTHETIC_ROOT:-/mnt/task_wrapper/user_output/artifacts/data/inference/testset20_89f_takano20250205_closeup_light_x4_lq_20260518}"
SYNTHETIC_S3="${SYNTHETIC_S3:-s3://lxh/data/test/testset20_89f_takano20250205_closeup_light_x4_lq_20260518}"
OUTPUT_S3="${OUTPUT_S3:-s3://lxh/data/test/ppt_benchmark_20closeup_synthetic_20260518}"
...
{
  echo "benchmark=ppt_benchmark_20closeup_synthetic_20260518"
...
if [[ "${START_OCCUPY_AFTER}" == "1" ]]; then
  ...
  tmux new-session -d -s occupy_pptbench_closeup "PYTHON_BIN=/mnt/conda_envs/flashvsr/bin/python GPUS='${GPU_LIST}' bash /mnt/task_runtime/bolt_lxh/occupy/gpu_stress_tc.sh"
fi
