...
CKPT_DIR="${CKPT_DIR:-/mnt/task_wrapper/user_output/artifacts/ckpts/stage2_v6_3_89f_step400_20260511}"
CKPT_S3_DIR="${CKPT_S3_DIR:-s3://bolt-prod-2320845741/tasks/b8gkuie2ns/artifacts/exp/train_stage2_release_48gpu_v6_3_lora_89f_videoonly_bs1_lr3e6_blocksparse_worker2_val_20260510_180600/output}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-/mnt/task_wrapper/user_output/artifacts/inference/stage2_v6_3_scan89_v61_step400_20260511}"
S3_OUTPUT_DIR="${S3_OUTPUT_DIR:-s3://lxh/tmp/stage2_v6_3_scan89_v61_step400_20260511}"
...
STEP_MOD="${STEP_MOD:-400}"
MIN_STEP="${MIN_STEP:-400}"
...
mkdir -p "${CKPT_DIR}" "${OUTPUT_ROOT}/logs" "${OUTPUT_ROOT}/_input_splits/part0" "${OUTPUT_ROOT}/_input_splits/part1"
...
ckpt_list="${OUTPUT_ROOT}/logs/stage2_v6_3_step400_s3_ckpt_list.txt"
...
printf '%s\n' "${CKPTS[@]}" > "${OUTPUT_ROOT}/logs/step400_to_test.txt"
echo "[info] new_ckpts_to_test=${#CKPTS[@]}"
cat "${OUTPUT_ROOT}/logs/step400_to_test.txt"
