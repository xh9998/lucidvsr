...
def add_training_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--max_train_steps", type=int, default=None, help="Maximum optimizer steps. Useful for iterable streaming datasets.")
...
def add_output_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--wandb_project", type=str, default="flashvsr", help="Weights & Biases project name.")
    ...
    parser.add_argument("--wandb_mode", type=str, default="online", help="Weights & Biases mode, e.g. online/offline/disabled.")
    return parser
